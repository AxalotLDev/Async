...
public class SynchronisePlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        mixin2MethodsExcludeMap.put("com.axalotl.async.mixin.SyncAllMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_2806", "method_12165", "()V"));
        syncAllSet.add("com.axalotl.async.mixin.SyncAllMixin");
