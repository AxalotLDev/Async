...
public class AsyncConfig {
    ...
    public static Map.Entry<String, Boolean> enableEntityMoveSync = new AbstractMap.SimpleEntry<>("enableEntityMoveSync", false);
    public static Map.Entry<String, Boolean> enableAsyncSpawn = new AbstractMap.SimpleEntry<>("enableAsyncSpawn", false);
    public static Map.Entry<String, Boolean> recoverFromErrors = new AbstractMap.SimpleEntry<>("recoverFromErrors", false);
