...
public final class Long2ObjectConcurrentHashMap<V> implements Long2ObjectMap<V> {
    ...
    // ── Spread function: Stafford variant 13 (SplittableRandom finalizer) ──
    ...
    /**
     * Immutable entry for safe external use and snapshot iteration.

     * Custom equals/hashCode overrides record defaults because
     * record-generated equals only matches other ImmutableEntry,
     * but Map.Entry contract requires matching ANY Map.Entry with same key+value.
     */
